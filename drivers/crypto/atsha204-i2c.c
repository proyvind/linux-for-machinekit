...
static int __exit atsha204_i2c_remove(struct i2c_client *client)
...
#ifdef CONFIG_OF
static const struct of_device_id atsha204_i2c_dt_ids[] = {
	{ .compatible = "atsha204-i2c-rng", },
	{ /* sentinel */ }
};
MODULE_DEVICE_TABLE(of, atsha204_i2c_dt_ids);
#endif

static struct i2c_driver atsha204_i2c_driver = {
        .driver = {
                .name = "atsha204-i2c",
		.of_match_table = of_match_ptr(atsha204_i2c_dt_ids),		
        },
